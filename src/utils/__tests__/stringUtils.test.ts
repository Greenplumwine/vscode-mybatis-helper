...
describe("stringUtils", () => {
  ...
  describe("extractTableNameFromMethod", () => {
    ...
    it("should extract table name from selectBy methods", () => {
      ...
      expect(extractTableNameFromMethod("selectUserOrderByUserId")).toBe(
        "user_order",
      );
    });
    ...
    it("should extract table name from get methods", () => {
      ...
      expect(extractTableNameFromMethod("getUserOrderListByUserId")).toBe(
        "user_order",
      );
    });
    ...
    it("should handle List suffix", () => {
      ...
      expect(extractTableNameFromMethod("selectUserOrderList")).toBe(
        "user_order",
      );
    });
