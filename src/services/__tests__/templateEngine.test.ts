...
describe('templateEngine', () => {
    ...
    describe('ResultMap Template', () => {
        it('should generate resultMap template', () => {
            ...
            expect(result.success).toBe(true);
            expect(result.content).toContain('<resultMap id="BaseResultMap" type="com.example.User">');
    ...
    describe('Mapper XML Template', () => {
        it('should generate mapper XML template', () => {
            ...
            expect(result.content).toContain('namespace="com.example.mapper.UserMapper"');
        });
    ...
    describe('Error Handling', () => {
        ...
        it('should fail for unknown template type', () => {
            ...
            const result = templateEngine.render('unknownType' as TemplateType, context);
            expect(result.success).toBe(false);
