...
export abstract class BaseCompletionStrategy implements CompletionStrategy {
   ...
   */
  protected getCurrentMethodName(context: CompletionContext): string | undefined {
    if (!context.xmlInfo) {
      return undefined;
    }
   ...
   */
  protected createCodeDocs(code: string, language: string = 'java'): vscode.MarkdownString {
